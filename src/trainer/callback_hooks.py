...
class TrainerCallbackHookMixin(ABC):
    ...
    def on_before_setting_dataloader_callbacks(self):
        for cb in self.callbacks:
            cb.on_before_setting_dataloader(self)

    def on_after_setting_dataloader_callbacks(self):
        for cb in self.callbacks:
            cb.on_after_setting_dataloader(self)
