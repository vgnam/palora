...
class SimpleMLP(nn.Module):
    ...
    def get_last_layer(self):
        ...
        if isinstance(self.seq, DumbWrapper):
            return self.seq.module[index]
...
class MultiTaskMLP(SharedBottom):
    def __init__(self, in_features, task_names, encoder_specs, decoder_specs):
        self.in_features = in_features
        self.encoder_specs = encoder_specs
        self.decoder_specs = decoder_specs
        encoder = SimpleMLP(
            in_features=in_features,
            hidden_features=encoder_specs,
