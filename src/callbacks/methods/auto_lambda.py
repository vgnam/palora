...
class AutoLambda(AlgoCallback):
    def __init__(self, num_tasks, meta_lr, weight_init=0.1):
        super().__init__(num_tasks)
        logging.info("Initializing AutoLambda.")
    ...
    def get_lr(self, trainer: "BaseTrainer"):
        if getattr(trainer, "scheduler", None) is None:
    ...
    def on_before_forward(self, trainer: "BaseTrainer", *args, **kwargs):
        if trainer.model.training:
            ...
            x_meta, y_meta = trainer._unpack_batch_functional(batch, self.device)
